...
class Settings(BaseSettings):
    ...
    db_url: str = os.environ.get(
        "DB_URL", "postgresql+asyncpg://test_user:password@db:5432/test_db"
    )
    # Database URL without async driver for migrations
    sync_db_url: str = db_url.replace("+aiosqlite", "")

    allowed_origins: list = os.environ.get("ALLOWED_HOSTS", ["http://localhost:5137"])
    allowed_headers: list = os.environ.get(
        "ALLOWED_HEADERS", ["Authorization", "Content-Type", "Set-Cookie"]
    )
    allowed_methods: list = os.environ.get(
    ...
    jwt_secret_key: str = os.environ.get(
        "SECRET_KEY",
        "",
    )
