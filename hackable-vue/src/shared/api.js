...
export default {
  ...
  async PUT(route, params, anonymous = false) {
    ...
    return Axios.put(url, isFormData ? formData : JSON.stringify(params), { headers }).catch(handleUnauthorized)
  },
  ...
  async PATCH(route, params, anonymous = false) {
    ...
    return Axios.patch(url, isFormData ? formData : JSON.stringify(params), { headers }).catch(handleUnauthorized)
  },
